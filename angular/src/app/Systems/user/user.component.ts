...
export class UserComponent implements OnInit, OnDestroy {
  ...
  showAddModal() {
    ...
    ref.onClose.subscribe((data: UserDto) => {
      if (data) {
        this.notificationService.showSucces(MessageConstants.CREATED_OK_MSG);
        this.selectedItems = [];
        this.loadData();
      }
    });
  ...
  showEditModal() {
    ...
    ref.onClose.subscribe((data: UserDto) => {
      if (data) {
        this.notificationService.showSucces(MessageConstants.UPDATED_OK_MSG);
        this.selectedItems = [];
  ...
  deleteItemsConfirm(ids: any[]) {
    ...
    this.userService.deleteMultiple(ids).subscribe({
      next: () => {
        this.notificationService.showSucces(MessageConstants.DELETED_OK_MSG);
        this.loadData();
        this.selectedItems = [];
        this.toggleBlockUI(false);
      },
  ...
  //     if (result) {
  //       this.notificationService.showSucces(MessageConstants.CHANGE_PASSWORD_SUCCCESS_MSG);
  //       this.selectedItems = [];
  //       this.loadData();
  //     }
  //   });
  ...
  assignRole(id: string) {
    ...
    ref.onClose.subscribe((result: boolean) => {
      if (result) {
        this.notificationService.showSucces(MessageConstants.ROLE_ASSIGN_SUCCESS_MSG);
        this.loadData();
      }
    });
  }
