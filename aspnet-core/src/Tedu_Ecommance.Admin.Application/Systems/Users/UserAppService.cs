        ...
        >, IUserAppService
    {
        ...
        public async Task<List<UserInlistDto>> GetListAllAsync(string filterKeyword)
        {
            ...
            if (!string.IsNullOrWhiteSpace(filterKeyword))
            {
                ...
                || x.Email.ToLower().Contains(filterKeyword)
                || x.PhoneNumber.ToLower().Contains(filterKeyword));
            }
        ...
        public async Task AssignRoleAsync(Guid userId, string[] roleName)
        {
            ...
            var addedResult = await _identityUserManager.AddToRolesAsync(user, roleName);
